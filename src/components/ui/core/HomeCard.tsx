  ...
  return (
    <li className="h-full">
      <a
        ...
        className="group glass-card block h-full rounded-3xl p-5 transition-[transform,box-shadow,border-color,background-color] duration-200 ease-out will-change-transform md:p-6"
      >
        <figure className="relative">
          ...
          >
            <div className="glass-surface-elevated flex aspect-[3/4] w-full items-center justify-center overflow-hidden rounded-xl transition-transform duration-200 ease-out will-change-transform group-hover:scale-[1.02]">
              <div
        ...
        <div className="mt-5 space-y-2 text-center">
          ...
          <p
            className={`bg-gradient-to-br text-4xl font-bold tracking-tight from-[color:var(--${accentColor})] via-[color:var(--${accentColor})]/80 to-[color:var(--${accentColor})]/60 bg-clip-text text-transparent group-hover:from-[color:var(--${accentColor})]/90 group-hover:to-[color:var(--${accentColor})]/70 transition-colors duration-150`}
          >
            {count}
          </p>
          <div
