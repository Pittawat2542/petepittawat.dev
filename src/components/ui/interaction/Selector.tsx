      ...
      <DropdownMenuTrigger asChild>
        <button
          ...
          className={cn(
            ...
            isEditorial ? 'selector--editorial' : 'glass-input',
        ...
        >
          <span
            className={cn(
              ...
              isEditorial ? 'selector__current--editorial' : 'text-[color:var(--white,#FFFFFF)]/85'
            )}
          >
            {current?.icon ? (
              <span
            ...
            <span
              className={cn(
                ...
                isEditorial ? 'selector__label--editorial' : 'text-[color:var(--white,#FFFFFF)]'
              )}
            >
              {current?.label}
            </span>
          ...
          <ChevronDown
            ...
            className={cn(
              ...
              isEditorial ? 'selector__chevron--editorial' : 'text-[color:var(--white,#FFFFFF)]/60'
            )}
            aria-hidden="true"
          />
        </button>
