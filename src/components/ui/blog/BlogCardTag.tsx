    ...
    return (
      <span
        ...
        style={{
          ...(tone === 'editorial'
            ? {
                borderColor:
                  'color-mix(in oklab, var(--card-accent,var(--accent)) 14%, rgba(255,255,255,0.18))',
                background:
                  'color-mix(in oklab, var(--card-accent,var(--accent)) 12%, rgba(15,23,42,0.42))',
              }
            : {
                borderColor:
      ...
      >
        <BookOpen
          ...
          className={
            tone === 'editorial'
              ? 'text-[color:var(--card-accent,var(--accent))]/72'
              : 'text-[color:var(--card-accent,var(--accent))]/90'
          }
        />
        {seriesTitle}
        {totalParts > 0 && (
          <span
            className={
              tone === 'editorial'
                ? 'text-white/52 transition-colors duration-300 group-hover:text-white/72'
                : 'text-white/70 transition-colors duration-300 group-hover:text-white/85'
            }
          >
