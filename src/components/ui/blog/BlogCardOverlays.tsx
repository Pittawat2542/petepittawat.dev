...
const BlogCardOverlaysComponent: FC = () => {
  return (
    <>
      ...
      <div className="pointer-events-none absolute inset-0 rounded-[inherit] bg-[linear-gradient(135deg,rgba(59,130,246,0.14)_0%,rgba(139,92,246,0.08)_40%,transparent_100%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
      ...
      <div className="pointer-events-none absolute -top-24 -right-20 h-44 w-44 rounded-full bg-[radial-gradient(circle,rgba(106,193,255,0.36),transparent_62%)] opacity-70 blur-3xl transition-all duration-500 group-hover:scale-110" />
    </>
  );
};
