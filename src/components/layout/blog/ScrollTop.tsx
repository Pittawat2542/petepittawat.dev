...
const ScrollTopComponent: React.FC = () => {
  ...
  return (
    <button
      ...
      title="Scroll to top"
      className="fixed bottom-6 right-6 z-30 inline-flex items-center justify-center h-11 w-11 rounded-full glass-button bg-muted/20 border-muted/40 hover:bg-muted/30 hover:border-muted/60 text-[color:var(--white)] hover:text-[color:var(--accent)] shadow-md shadow-black/10 transition-[opacity,transform,box-shadow,color,background-color,border-color] duration-200 ease-out will-change-transform active:scale-[0.98] opacity-0 translate-y-2 pointer-events-none"
      style={{
