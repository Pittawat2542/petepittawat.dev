...
coverImage: '../casting-vs-coercing/cover.png'
...
_However, in most languages, this type of conversion only changes the **value**—the data stored in the variable itself remains unchanged in its original type, unless we explicitly reassign it back._
