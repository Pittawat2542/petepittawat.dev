...
coverImage: '../ai-collaborator/cover.png'
lang: 'en'
...
<Callout type="note" title="Context">
  This article reflects the landscape around mid‑2023. Since then, agentic systems have evolved
  quickly (e.g., multi‑modal reasoning and better tool use). The core ideas still hold, but examples
  and capabilities may have advanced.
</Callout>
